...
const Edge = ({ slug, content, onClose, isMaximized, onRestore }, ref) => {
    return (
        <Draggable
        ...
        >
            <div
                ...
                ref={ref}
            >
                <div className="absolute top-0 w-full h-10 flex justify-between edge-drag-handle cursor-move">
                ...
                <div className="absolute top-[4.75rem] h-[calc(100vh-7.75rem)] w-full bg-white rounded-lg p-8 overflow-scroll">
                {content}
                </div>
