            ...
            <div className='bg-[#2e2e2e] w-full h-[calc(100vh-3rem)]'>
                ...
                <div className="bg-[#3b3b3b] absolute top-[2.5rem] w-full h-9 flex p-1 gap-4">
                    <div className="flex items-center h-full pl-2 pr-2 w-20 text-xl justify-between">
                        <FiArrowLeft className='bg-transparent flex h-full group active:scale-100 p-1 hover:bg-[#ffffff20] duration-300 rounded'/>  
                        <MdOutlineRefresh className='bg-transparent flex  h-full group active:scale-100 p-1 hover:bg-[#ffffff20] duration-300 rounded'/>
                    </div>
