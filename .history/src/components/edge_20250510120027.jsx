        ...
        <div className='bg-[#2e2e2e] w-full h-[calc(100vh-3rem)]'>
            ...
            <div className="absolute top-0 w-full h-10 flex justify-between">
                <div className="items w-1/4 flex items-center ">
                    <div className='w-24 500 h-full flex after:content-[""] after:w-3 after:h-3 after:bg-[#000] after:bottom-[-2px] after:right-0 after:absolute relative after:rounded-full'>
