    ...
    const Edge = () =>{
        return(
            <div className='bg-[#2e2e2e] w-full h-[calc(100vh-3rem)]'>
                ...
                <div className="bg-[#3b3b3b] absolute top-[2.5rem] w-full h-9">
                    <div className="flex items-center h-full pl-2 pr-2 w-20 bg-red-500 text-xl justify-between">
                        <FiArrowLeft/>  
                        <MdOutlineRefresh/>
                    </div>

                    <div className="bg-green-700 w-full"></div>
