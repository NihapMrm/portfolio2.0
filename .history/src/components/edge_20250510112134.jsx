        ...
        <div className='bg-[#2e2e2e] w-full h-[calc(100vh-3rem)]'>
            <div className="absolute top-0 w-full h-10 flex justify-between">
                <div className="items bg-red-600 w-1/4">
                    <div className='w-24 bg-yellow-500 h-full flex'>
                        <FiLayers className="bg-transparent flex w-10 h-9 group active:scale-100 p-2 hover:bg-[#ffffff20] duration-300"/>
                        <FiLayout className="bg-transparent flex w-10 h-9 group active:scale-100 p-2 hover:bg-[#ffffff20] duration-300"/>
                    </div>
                </div>
