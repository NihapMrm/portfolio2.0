        ...
        <div className='bg-[#2e2e2e] w-full h-[calc(100vh-3rem)]'>
            ...
            <div className="absolute top-0 w-full h-10 flex justify-between">
                <div className="items w-1/4 flex items-center">
                    ...
                    <div className='bg-[#3b3b3b] w-64 h-full rounded-tl-xl rounded-tr-xl after:content-[""] after:w-3 after:h-3 after:bg-[#000] after:bottom-[-2px] after:left-[-0.375rem] after:absolute relative after:rounded-full'></div>
                </div>
