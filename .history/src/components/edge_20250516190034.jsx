            ...
            <div className='bg-[#2e2e2e] w-full h-[calc(100vh-3rem)]'>
                ...
                <div className="bg-[#3b3b3b] absolute top-[2.5rem] w-full h-9 flex p-1">
                    ...
                    <div className="w-28 flex">
                        ...
                        <img src='/src/images/profile.webp' className='h-full rounded-full bg-transparent flex w-10 h-full group active:scale-100 p-1 hover:bg-[#ffffff20] duration-300 rounded'/>
                    </div>
