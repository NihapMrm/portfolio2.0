            ...
            <div className='bg-[#2e2e2e] w-full h-[calc(100vh-3rem)]'>
                ...
                <div className="bg-[#3b3b3b] absolute top-[2.5rem] w-full h-9 flex p-1">
                    ...
                    <div className="bg-[#2e2e2e] w-full h-full rounded-full border flex items-center justify-start border-white border-opacity-20 gap-2 hover:bg-[#3b3b3b] transition-all">
                        ...
                        <p className='text-base pb-[2px]'>nihap.me/skills</p>
                    </div> 
                    <div className="w-28 flex">
                        <PiListStar className='bg-transparent flex w-10 h-full group active:scale-100 p-[0.6rem] hover:bg-[#ffffff20] duration-300 rounded'/>
                        <img src='/src/images/profile.webp' className='h-full rounded-full'/>
                    </div>
