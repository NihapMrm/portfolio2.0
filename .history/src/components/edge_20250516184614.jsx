    ...
    const Edge = () =>{
        return(
            <div className='bg-[#2e2e2e] w-full h-[calc(100vh-3rem)]'>
                ...
                <div className="bg-[#3b3b3b] absolute top-[2.5rem] w-full h-9 flex p-1">
                    <div className="flex items-center h-full pl-2 pr-2 w-20 text-xl justify-between">
                        <FiArrowLeft/>  
                        <MdOutlineRefresh/>
                    </div>

                    <div className="bg-[#2e2e2e] w-full h-full rounded-full border flex items-center justify-start border-white border-opacity-20 gap-2 hover:bg-[#3b3b3b]">
                        <AiOutlineExclamationCircle className='bg-[#3b3b3b] bg-opacity-50 h-full rounded-full w-7 p-1 '/>
                        <p className='text-base'>nihap.me/skills</p>
                    </div> 
